...
interface IVMasker {
  (element: any): any;
  toPattern(value, options): string;
  toMoney(value): string;
}
declare var VMasker: IVMasker;
...
// Extra variables that will be replaced by webpack DefinePlugin
declare const build: {
  env: {
    ENV: string;
    APP_ID: string;
...
declare namespace Snap {
  ...
  export function animate(from: number | number[],
                          to: number | number[],
  ...
  export interface Element {
    ...
    animate(attrs: { [attr: string]: string | number | boolean | any },
            duration: number,
            easing?: (num: number) => number,
